...
const speakerProfiles: Record<string, SpeakerProfile> = {
  ...
  'Гриневич В.Б.': {
    ...
    photoPosition: 'center 16%',
    credentials:
      'д.м.н., профессор, полковник медицинской службы, главный гастроэнтеролог Министерства обороны РФ, заведующий 2-й кафедрой терапии (усовершенствования врачей) Военно-медицинской академии им. С.М. Кирова. Санкт-Петербург.',
  },
  'Завалишина Л.Э.': {
    ...
    credentials:
      'д.б.н., профессор кафедры патологической анатомии ФГБАУ РМАНПО Минздрава России, эксперт Центра контроля качества иммуногистохимических исследований ФГБАУ РМАНПО Минздрава России.',
  },
  'Кутина Н.И.': {
  ...
  'Друй А.Е.': {
    ...
    photoPosition: 'center 18%',
    credentials:
      'д.м.н., заведующий лабораторией молекулярной онкологии, доцент кафедры патологической анатомии и клинической лабораторной диагностики ФГБУ «НМИЦ ДГОИ им. Дмитрия Рогачева» Минздрава России. Москва; заведующий лабораторией молекулярно-генетических исследований ЛДЦ МИБС. Санкт-Петербург.',
  },
  'Вторушин С.В.': {
...
const conferenceProgram: ProgramItem[] = [
  ...
  },
  {
    ...
    title: 'Хронический гастрит. Взгляд клинициста.',
  },
  {
    kind: 'discussion',
    time: '10:50–11:00',
  ...
  },
  {
    ...
    title:
      'Ключевые проблемы преаналитического этапа иммуногистохимического и молекулярно-генетического исследования',
  },
  {
    kind: 'talk',
    time: '11:30–11:45',
    ...
    speaker: 'Кутина Н.И.',
    title:
      'Современные требования к макроскопическому исследованию и вырезке операционного материала в онкопатологии',
  },
  {
    kind: 'talk',
    time: '11:45–12:15',
  ...
  },
  {
    ...
    speaker: 'Раскин Г.А.',
    title:
      'Молекулярная генетика и эпигенетика в повседневной диагностике опухолей мягких тканей и костей',
  },
  {
    kind: 'discussion',
    time: '15:00–15:20',
